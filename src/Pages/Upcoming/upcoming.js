import { getTrending, getUpcoming } from '../../service/service.js';

async function displayTrendingMovies() {
  const carouselTrack = document.getElementById('upcoming-movies');

  try {
    const data = await getUpcoming(); // Récupérer les films depuis l'API
